...
import { ArrowLeft, ArrowRight, BarChart, TrendingUp, Users, Calendar, CheckCircle, Target } from 'lucide-react';
...
const caseStudies: Record<string, CaseStudy> = {
  'techcorp': {
    ...
    implementation: [
      {
        ...
        description: 'Fixed site architecture, improved page speed, implemented schema markup, and resolved mobile usability issues.',
        icon: Target
      },
      {
        title: 'Content Strategy',
        description: 'Created 24 high-quality blog posts, 4 comprehensive guides, and optimized 15 key landing pages.',
        icon: CheckCircle
      },
      {
        title: 'Link Building Campaign',
        description: 'Secured 45+ high-quality backlinks from industry publications and relevant websites.',
        icon: TrendingUp
      }
    ],
    results: [
    ...
    testimonial: {
      quote: "The MaaS team transformed our digital presence. Their data-driven approach to SEO delivered results beyond our expectations, and their transparent reporting made it easy to see the ROI. We've not only increased our organic traffic significantly but also improved the quality of leads coming through our website.",
  ...
  'growthwave': {
    ...
    implementation: [
      {
        title: 'Content Strategy',
        description: 'Developed 90-day content calendar with product features, user-generated content, educational posts, and lifestyle content.',
        icon: CheckCircle
      },
      {
        title: 'Community Building',
        description: 'Implemented proactive engagement strategy, responding to all comments and messages within 2 hours.',
        icon: Users
      },
      {
        title: 'Paid Social Campaigns',
        description: 'Created segmented ad campaigns targeting different audience segments with tailored messaging.',
        icon: Target
      }
    ],
    results: [
    ...
    testimonial: {
      quote: "Working with MaaS has been transformative for our business. Their social media strategy not only increased our engagement but directly impacted our bottom line. The team's attention to detail and data-driven approach helped us connect with our audience in a meaningful way that translated to real sales.",
      author: "Michael Chen",
      position: "CEO, GrowthWave",
      image: "https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
    },
    logo: 'https://images.unsplash.com/photo-1516876437184-593fda40c7ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=80&q=80',
    image: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&h=630&q=80',
    timeline: '4 months',
    nextSteps: [
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">The case study you're looking for doesn't exist or has been removed.</p>
          <Link to="/case-studies" className="mt-4 inline-flex items-center text-indigo-600 hover:text-indigo-500">
    ...
    <div className="bg-white">
      ...
      <div className="relative pt-32 pb-16 sm:pb-24 bg-gradient-to-r from-indigo-700 to-purple-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <Link to="/case-studies" className="inline-flex items-center text-indigo-100 hover:text-white mb-6">
              <ArrowLeft className="mr-2 h-5 w-5" />
              Back to Case Studies
            </Link>
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-8">
          <div className="lg:col-span-1">
            <img 
              ...
              className="h-24 bg-white p-2 rounded shadow"
            />
            <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Company Overview</h2>
          </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div>
              <h2 className="text-3xl font-extrabold text-gray-900">The Challenge</h2>
      ...
      {/* Strategy & Execution */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-extrabold text-gray-900 text-center mb-12">Strategy & Execution</h2>
          ...
          <ul className="space-y-4">
            {caseStudy.approach.map((step, index) => (
              <li key={index} className="flex items-start">
                ...
                <p className="ml-4 text-lg text-gray-600">{step}</p>
              </li>
            ))}
          </ul>
        </div>
      ...
      <div className="bg-indigo-700 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white text-center mb-12">Results & Key Metrics</h2>
          
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {caseStudy.results.map((result, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg p-6 text-center">
                <result.icon className="h-12 w-12 mx-auto text-indigo-600" />
                <p className="mt-4 text-4xl font-bold text-indigo-600">{result.value}</p>
                <p className="mt-2 text-lg font-medium text-gray-900">{result.metric}</p>
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="lg:col-span-1 p-12">
              ...
              <div className="mt-6">
                <p className="text-base font-medium text-gray-900">{caseStudy.testimonial.author}</p>
                <p className="text-base text-gray-500">{caseStudy.testimonial.position}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {caseStudy.nextSteps && (
        <div className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-extrabold text-gray-900 text-center mb-12">Next Steps</h2>
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-600 mb-6">
                Building on the success of this campaign, we've identified the following opportunities for continued growth:
              </p>
              <ul className="space-y-4">
          ...
          <div className="px-6 py-12 sm:px-12 lg:py-16 lg:px-16 lg:flex lg:items-center lg:justify-between">
            <div>
              <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                ...
                <span className="block text-indigo-200">Let's Talk About Your Business.</span>
              </h2>
              <p className="mt-4 text-lg leading-6 text-indigo-200">
                Schedule a free consultation to see how we can help you achieve your marketing goals.
              </p>
            </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-gray-900 text-center mb-12">Related Case Studies</h2>
