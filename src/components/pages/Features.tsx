...
const features = [
  {
    ...
    description: 'Get your marketing requests delivered faster with our streamlined process and dedicated team.',
    icon: Clock,
  },
  {
    name: 'Dedicated Marketing Manager',
    description: 'Work directly with an experienced marketing professional who understands your business goals.',
    icon: Users,
  },
  {
    name: 'Real-Time Performance Insights',
    description: 'Track campaign performance and ROI with our comprehensive analytics dashboard.',
    icon: BarChart,
  },
  {
    name: 'Access to Top Marketing Experts',
    description: 'Leverage the expertise of our seasoned marketing professionals across all channels.',
    icon: Zap,
  },
];
...
const integrations = [
  {
    name: 'Slack',
    description: 'Seamless communication and project updates through Slack integration.',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Slack_icon_2019.svg/2048px-Slack_icon_2019.svg.png',
  },
  {
    name: 'Microsoft Teams',
    description: 'Collaborate effectively with Teams integration for enterprise clients.',
  ...
  {
    name: 'HubSpot',
    description: 'Seamless CRM integration with HubSpot for better lead management.',
  ...
  return (
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Discover how our tech-driven platform delivers fast, scalable marketing solutions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-500">Everything you need to scale your marketing efforts</p>
          </div>

          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature) => (
              <div key={feature.name} className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-500">Simple steps to marketing success</p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Tell us what you need through our intuitive platform',
                },
                {
                  step: '02',
                ...
                <div key={step.step} className="relative">
                  <div className="border-2 border-indigo-600 rounded-lg p-6">
                    <span className="text-4xl font-bold text-indigo-600">{step.step}</span>
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">Integration Capabilities</h2>
            <p className="mt-4 text-lg text-gray-500">Connect with your favorite tools</p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {integrations.map((integration) => (
              <div key={integration.name} className="bg-white rounded-lg shadow-lg p-6">
                ...
                />
                <h3 className="mt-4 text-lg font-medium text-center text-gray-900">{integration.name}</h3>
                <p className="mt-2 text-center text-gray-500">{integration.description}</p>
              </div>
            ))}
          </div>
        </div>
