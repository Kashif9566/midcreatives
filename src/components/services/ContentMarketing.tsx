...
const stats: StatCard[] = [
  {
    ...
    value: '3x',
    description: 'More leads than traditional marketing',
    icon: Target
  },
  {
    title: 'Cost Reduction',
    value: '62%',
    description: 'Lower cost per lead acquisition',
    icon: Zap
  },
  {
  ...
  },
  {
    ...
    value: '78%',
    description: 'Increased brand trust',
    icon: Globe
  }
];
...
const features: ServiceFeature[] = [
  {
    ...
    description: 'Data-driven content planning and roadmap development.',
    icon: PenTool,
    benefits: [
      'Audience research',
  ...
  },
  {
    ...
    description: 'High-quality blog posts, articles, and whitepapers.',
    icon: FileText,
    benefits: [
      'SEO optimization',
  ...
  },
  {
    ...
    description: 'Multi-channel content promotion and outreach.',
    icon: Target,
    benefits: [
  ...
  },
  {
    ...
    description: 'Content tracking and ROI measurement.',
    icon: BarChart,
    benefits: [
      'Engagement metrics',
      'Conversion tracking',
  ...
  },
  {
    ...
    description: 'Content optimization for search visibility.',
    icon: Target,
    benefits: [
      'Keyword research',
  ...
  {
    title: 'Content Audit',
    description: 'Comprehensive content performance analysis.',
    icon: FileText,
    benefits: [
      'Content inventory',
      'Quality assessment',
            ...
            {[
              {
                ...
                description: 'Analyze audience and competitors',
                icon: Target
              },
              {
                step: '02',
                title: 'Content Strategy',
                description: 'Develop comprehensive roadmap',
                icon: PenTool
              },
              {
                step: '03',
            ...
            <div className="relative px-6 py-16 sm:px-12 sm:py-20 lg:px-16">
              <div className="relative max-w-3xl mx-auto text-center">
                ...
                <div className="mt-6 text-xl text-indigo-100">
                  "The content strategy transformed our brand authority. Our blog traffic increased by 312% and lead generation improved by 156% within 6 months."
                </div>
  ...
  <div className="max-w-5xl mx-auto py-16 px-4 sm:px-6 lg:px-6">
    <div className="bg-primary rounded-lg shadow-xl overflow-hidden">
      <div className="flex flex-col items-center justify-center text-center px-6 py-16 sm:px-8 lg:px-8">
        ...
        >
          <AnimatedButton>          Book a Free Consultation</AnimatedButton>
