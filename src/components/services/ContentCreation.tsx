        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-indigo-600 mt-2">Converts, and Grows Your Brand</span>
            </h1>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900">Our Content Creation Services</h2>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-500">A streamlined process for exceptional content</p>
          </div>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            <span className="block">Let's Create Something Incredible Together</span>
          </h2>
          <p className="mt-4 text-lg leading-6 text-gray-500">
            Start your content journey today with our expert team.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <a
              href="/contact"
