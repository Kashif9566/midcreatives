  ...
  return (
    <div className="bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-medium text-gray_remote">Our Email Marketing Services</h2>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-medium text-gray_remote">Our Email Marketing Process</h2>
            <p className="mt-5 text-lg text-[#727986]">A proven methodology for email success</p>
          </div>
